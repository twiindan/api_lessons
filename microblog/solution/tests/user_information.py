...
class TestGetUserInformation():
    ...
    def test_get_user_information(self):
        ...
        response = self.microblog.get_user_information(headers=headers, user_id=1)
    ...
    def test_modify_profile(self):
        ...
        response = self.microblog.modify_user_information(headers=headers, user_id=1, body=body.to_dict())
